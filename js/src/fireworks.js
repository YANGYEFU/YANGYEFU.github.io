...
function animateParticules(e,t) {
    ...
    anime.timeline().add({targets:n,x:function(e) {
        ...
        return e.endPos.y
    },radius:0.1,duration:anime.random(1200,1800),easing:"easeOutExpo",update:renderParticule}).add({targets:a,radius:anime.random(80,160),lineWidth:0,alpha:{value:0,easing:"linear",duration:anime.random(600,800)},duration:anime.random(1200,1800),easing:"easeOutExpo",update:renderParticule,offset:0})
}
...
if(canvasEl) {
    ...
    },500),render=anime({duration:1/0,update:function() {
